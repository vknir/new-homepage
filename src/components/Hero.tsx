    ...
    return <div className='my-7 flex flex-col gap-6 items-start lg:my-0'>
        ...
        <div className='flex flex-col gap-4 lg:flex-row  lg:gap-10'>
            ...
            <div className='flex flex-col items-start gap-4'>
                <p className='text-dark-grayish-blue text-left text-lg/8'>We dive into next evolution of web that claims to put the power of platforms back into the hands of the people. But is it really fulfilling its promise?</p>
